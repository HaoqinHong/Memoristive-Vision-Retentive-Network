...
import datetime
import os
from solver_retnet import Solver
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dset', type=str, default='mnist', help=['mnist', 'fmnist', 'cifar10'])
    ...
    # 是否使用池化
    parser.add_argument('--pooling', type=bool, default=False, help='Use pooling')
